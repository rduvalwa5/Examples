...
filename = '/Users/rduvalwa2/git/Examples/SqlLite_Examples/Sqlite_Notes/album2songs.csv'
...
#  statement = "INSERT INTO album_covers VALUES(cover_idx,album_cover,album,description),(cover_idx,album_cover,album,description);)
                statement = "INSERT INTO album2songs VALUES(\"" + row[0]+ "\",\"" + row[1]+ "\",\"" + row[2] + "\",\"" + row[3] +"\",\"" + row[4] + "\",\"" + row[5] + "\",\"" + row[6] + "\",\"" + row[7] +  "\");"
